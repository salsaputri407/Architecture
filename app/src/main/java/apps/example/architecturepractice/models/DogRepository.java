package apps.example.architecturepractice.models;

import androidx.lifecycle.LiveData;
import androidx.lifecycle.MutableLiveData;

import apps.example.architecturepractice.services.ApiClient;
import apps.example.architecturepractice.services.DogService;
